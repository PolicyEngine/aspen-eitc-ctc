...
def create_aspen_parametric_reform():
    """Parametric-only version of the Aspen reform for the household path.

    Equivalent to ``create_aspen_reform()`` except it returns a single
    ``Reform`` built from ``Reform.from_dict`` rather than the 5-tuple
    that includes custom ``Variable`` overrides. This is the form passed
    to ``calculate_household(reform=...)`` in the new policyengine API
    and also works with raw ``policyengine_us.Simulation``.

    The custom ``eitc_maximum`` override from the original reform
    (which preserved current-law EITC for childless filers) is replaced
    by enabling ``gov.contrib.streamlined_eitc.in_effect`` and applying
    a post-calc patch in ``household_calculation.py`` that sets the
    reform net income equal to baseline when ``eitc_child_count == 0``.
    """
    date_range = "2026-01-01.2100-12-31"
    return Reform.from_dict(
        {
            "gov.contrib.streamlined_eitc.in_effect": {date_range: True},
            "gov.contrib.streamlined_eitc.max.single[1].amount": {date_range: 3995},
            "gov.contrib.streamlined_eitc.max.joint[1].amount": {date_range: 4993},
            "gov.irs.credits.eitc.phase_in_rate[1].amount": {date_range: 0.34},
            "gov.irs.credits.eitc.phase_in_rate[2].amount": {date_range: 0.34},
            "gov.irs.credits.eitc.phase_in_rate[3].amount": {date_range: 0.34},
            "gov.irs.credits.eitc.phase_out.start[1].amount": {date_range: 21560},
            "gov.irs.credits.eitc.phase_out.start[2].amount": {date_range: 21560},
            "gov.irs.credits.eitc.phase_out.start[3].amount": {date_range: 21560},
            "gov.irs.credits.eitc.phase_out.joint_bonus[1].amount": {date_range: 5390},
            "gov.irs.credits.eitc.phase_out.rate[1].amount": {date_range: 0.1598},
            "gov.irs.credits.eitc.phase_out.rate[2].amount": {date_range: 0.1598},
            "gov.irs.credits.eitc.phase_out.rate[3].amount": {date_range: 0.1598},
            "gov.irs.credits.ctc.phase_out.arpa.in_effect": {date_range: True},
            "gov.irs.credits.ctc.amount.arpa[0].amount": {date_range: 3600},
            "gov.irs.credits.ctc.amount.arpa[1].amount": {date_range: 3000},
            "gov.irs.credits.ctc.phase_out.threshold.SINGLE": {date_range: 75000},
            "gov.irs.credits.ctc.phase_out.threshold.HEAD_OF_HOUSEHOLD": {date_range: 75000},
            "gov.irs.credits.ctc.phase_out.threshold.JOINT": {date_range: 110000},
            "gov.irs.credits.ctc.phase_out.threshold.SURVIVING_SPOUSE": {date_range: 110000},
            "gov.irs.credits.ctc.phase_out.threshold.SEPARATE": {date_range: 55000},
            "gov.irs.credits.ctc.phase_out.arpa.threshold.SINGLE": {date_range: 75000},
            "gov.irs.credits.ctc.phase_out.arpa.threshold.HEAD_OF_HOUSEHOLD": {date_range: 75000},
            "gov.irs.credits.ctc.phase_out.arpa.threshold.JOINT": {date_range: 110000},
            "gov.irs.credits.ctc.phase_out.arpa.threshold.SURVIVING_SPOUSE": {date_range: 110000},
            "gov.irs.credits.ctc.phase_out.arpa.threshold.SEPARATE": {date_range: 55000},
            "gov.contrib.ctc.linear_phase_out.in_effect": {date_range: True},
            "gov.contrib.ctc.linear_phase_out.end.SINGLE": {date_range: 240000},
            "gov.contrib.ctc.linear_phase_out.end.HEAD_OF_HOUSEHOLD": {date_range: 240000},
            "gov.contrib.ctc.linear_phase_out.end.JOINT": {date_range: 440000},
            "gov.contrib.ctc.linear_phase_out.end.SURVIVING_SPOUSE": {date_range: 440000},
            "gov.contrib.ctc.linear_phase_out.end.SEPARATE": {date_range: 175000},
            "gov.irs.credits.ctc.refundable.individual_max": {date_range: 3600},
            "gov.irs.credits.ctc.refundable.phase_in.rate": {date_range: 0.30},
            "gov.irs.credits.ctc.refundable.phase_in.threshold": {date_range: 0},
            "gov.contrib.ctc.minimum_refundable.in_effect": {date_range: True},
            "gov.contrib.ctc.minimum_refundable.amount[0].amount": {date_range: 1800},
            "gov.contrib.ctc.minimum_refundable.amount[1].amount": {date_range: 1500},
        },
        country_id="us",
    )
